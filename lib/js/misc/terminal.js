    ...
    module.exports = {
        ...
        help: function(v) {
            this.out('The single tag template compiler\n', 'bold')
                ...
                .out('    --expand       Expand content in style and script tags\n', 'white', false)
                .out('    --minify, --m  Minify output (takes precedence over expand)\n', 'white', false)
                ...
                .out('    * NOTE: This feature has not yet been tested\n\n', 'white', false);
            return this;
        }
    };
})();
